...
public class BeatBoxFinal {  // implements MetaEventListener 
      ...
      public void buildGUI() {
          ...
          saveIt.addActionListener(new mySendListener2());
		  ...
		  JButton clearIt = new JButton("Clear It");
		  clearIt.addActionListener(new myCleanListener());
...
//==============================================================       
	...
	public class mySendListener2 implements ActionListener
	{
		public void actionPerformed(ActionEvent a)
		{
			boolean [] checkboxState = new boolean[256];
